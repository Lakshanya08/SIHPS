...
8.Positioning Server: BLE/Wi-Fi fingerprint DB + trilateration server; optional VIO model for camera-based indoor localization.
9.Analytics: Clickhouse or BigQuery for large-scale analytics.
...
6.TTS / STT engines (for multilingual voice guidance).
7.Payment / Ticketing APIs (if integrating ticket kiosks).
8.SMS/Notification gateways for critical alerts.
9.GIS tools: QGIS for map editing and validation.
